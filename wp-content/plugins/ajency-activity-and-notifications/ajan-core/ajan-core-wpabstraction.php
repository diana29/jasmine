 ...
 * running and will alter the environment so ActivityNotifications can run regardless.
 *
 ...
 *
 * @since ActivityNotifications (1.5.2)
 *
 * @global string $wp_version
 * @return string $wp_version
 */
function ajan_get_major_wp_version() {
	global $wp_version;
 ...
 */
function ajan_core_get_status_sql( $prefix = false ) {
	if ( !is_multisite() )
