 ...
 * @since ajency-activity-and-notifications (1.9.0)
 */
class AJAN_Notifications_Notification {
	...
	public function save() {
		...
		do_action_ref_array( 'ajan_notification_before_save', array( &$this ) );
		...
		do_action_ref_array( 'ajan_notification_after_save', array( &$this ) );
	...
	public function populate() {
		...
		$notification = $wpdb->get_row( $wpdb->prepare( "SELECT * FROM {$ajan->notifications->table_name} WHERE id = %d", $this->id ) );
	...
	protected static function _insert( $data = array(), $data_format = array() ) {
		global $wpdb;
		return $wpdb->insert( activitynotifications()->notifications->table_name, $data, $data_format );
	}
	 ...
	 *        AJAN_Notification_Notification object.
	...
	protected static function _update( $data = array(), $where = array(), $data_format = array(), $where_format = array() ) {
		global $wpdb;
		return $wpdb->update( activitynotifications()->notifications->table_name, $data, $where, $data_format, $where_format );
	}
	...
	protected static function _delete( $where = array(), $where_format = array() ) {
		global $wpdb;
		return $wpdb->delete( activitynotifications()->notifications->table_name, $where, $where_format );
	}

	/**
	 * Assemble the WHERE clause of a get() SQL statement.
	 *
	 * Used by AJAN_Notifications_Notification::get() to create its WHERE
	 * clause.
	 *
	 * @since ajency-activity-and-notifications (1.9.0)
	 *
	 * @param array $args See {@link AJAN_Notifications_Notification::get()}
	 *        for more details.
	 ...
	 *
	 * Used by AJAN_Notifications_Notification::get() to create its ORDER BY
	 * clause.
	 *
	 * @since ajency-activity-and-notifications (1.9.0)
	 *
	 ...
	 *
	 * Used by AJAN_Notifications_Notification::get() to create its LIMIT clause.
	 *
	 * @since ajency-activity-and-notifications (1.9.0)
	 *
	 * @param array $args See {@link AJAN_Notifications_Notification::get()}
	 ...
	 *        See {@AJAN_Notifications_Notification::get()} for a breakdown.
	...
	public static function get( $args = array() ) {
		...
		$r  = wp_parse_args( $args, array(
			...
			'component_name'    => ajan_notifications_get_registered_components(),
		...
		// FROM
		$from_sql   = "FROM " . activitynotifications()->notifications->table_name;
	 ...
	 * @since ajency-activity-and-notifications (1.9.0)
	 *
	 * @see AJAN_Notifications_Notification::get() for a description of
	 *      arguments.
	 *
	 * @param array $args See {@link AJAN_Notifications_Notification::get()}.
	...
	public static function get_total_count( $args ) {
		...
		$from_sql   = "FROM {$ajan->notifications->table_name}";
	...
	public static function update( $update_args = array(), $where_args = array() ) {
		...
		if ( ! empty( $where_args['user_id'] ) ) {
			wp_cache_delete( 'all_for_user_' . $where_args['user_id'], 'ajan_notifications' );
		}
	...
	public static function delete( $args = array() ) {
		...
		do_action( 'ajan_notification_before_delete', $args );
	 ...
	 * @since ajency-activity-and-notifications (1.9.0)
	 *
	 * @see AJAN_Notifications_Notification::delete() for explanation of
	 *      return value.
	 *
